...
from keras.layers import MaxPooling2D, Dense, BatchNormalization
...
model = keras.models.Sequential([Conv2D(12, (5, 5), activation='relu', kernel_initializer='glorot_uniform', input_shape=(60, 60, 3)),
                                 Conv2D(32, (3, 3), activation='relu', kernel_initializer='glorot_uniform'),
                                 ...
                                 Conv2D(196, (1, 1), activation='relu'),
                                 MaxPooling2D(2, 2),
                                 MaxPooling2D(1, 1),
                                 BatchNormalization(),
                                 keras.layers.Flatten(),
...
m = pretrained_model(num_units=150)
